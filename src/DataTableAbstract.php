...
namespace JeffersonCarvalho\DataTables;
...
use JeffersonCarvalho\DataTables\Contracts\DataTable;
use JeffersonCarvalho\DataTables\Contracts\Formatter;
use JeffersonCarvalho\DataTables\Processors\DataProcessor;
use JeffersonCarvalho\DataTables\Utilities\Helper;
...
abstract class DataTableAbstract implements DataTable
{
     ...
     * @param  string|callable|\JeffersonCarvalho\DataTables\Contracts\Formatter  $formatter
     * @return $this
     */
    ...
    {
        if (isset($this->transformer) && class_exists('JeffersonCarvalho\\DataTables\\Transformers\\FractalTransformer')) {
     ...
     *
     * @throws \JeffersonCarvalho\DataTables\Exceptions\Exception|\Exception
     */
