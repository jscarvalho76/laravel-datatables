...
use JeffersonCarvalho\DataTables\Exceptions\Exception;
use JeffersonCarvalho\DataTables\Utilities\Config as DataTablesConfig;
use JeffersonCarvalho\DataTables\Utilities\Request;
        ...
        foreach ($builders as $class => $engine) {
            if (is_string($class) && $source instanceof $class) {
                ...
                if (is_callable($callback)) {
                    /** @var \JeffersonCarvalho\DataTables\DataTableAbstract $instance */
