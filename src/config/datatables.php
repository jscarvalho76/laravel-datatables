...
return [
     ...
     */
    'engines' => [
        'eloquent' => JeffersonCarvalho\DataTables\EloquentDataTable::class,
        'query' => JeffersonCarvalho\DataTables\QueryDataTable::class,
        'collection' => JeffersonCarvalho\DataTables\CollectionDataTable::class,
        'paginator' => JeffersonCarvalho\DataTables\PaginatorDataTable::class,
        'resource' => JeffersonCarvalho\DataTables\ApiResourceDataTable::class,
    ],
